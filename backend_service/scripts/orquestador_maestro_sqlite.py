...
from modulo_guardado_sqlite import guardar_fichas
from modulo_enriquecimiento_sqlite import enriquecer_fichas
from modulo_exportacion_json import exportar_a_json

def ejecutar_flujo_completo():
    print("\n🚀 INICIANDO ORQUESTADOR MAESTRO - SQLite")
    print("===================================")
    ...
    # 4. Exportar a JSON
    print("\n📤 PASO 4: Exportando resultados a JSON...")
    exportar_a_json()
